...
const projectDetails = {
  ...
  '03': { text: "DISTRIBUTED TELEMETRY • MICROSERVICE MAPPING • MEMORIANT • ", color: "#ff4d88", bgColor: "#26000d" },
  '04': { text: "RESTRICTED DATA VAULT • SECURE CLOUD SYSTEM • PROJECT DELTA • ", color: "#4dff88", bgColor: "#001f0a" }
};
